print("KIVANÇ ADIGÜZEL MIUUL PYTHON WEEK1 EXERCISES")
############################
...
############################
# Görev 4: veilen sözlük yapısına aşağıdaki adımları uygulayınız
############################
...
def kümeler(kume1, kume2):
    if kume1.issuperset(kume2):
        birlesim = (kume1.intersection(kume2))
        print(birlesim)
    else:
